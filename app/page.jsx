      ...
      <main id="top">
        ...
        <section className="section" id="faq">
          <div className="wrap narrow">
            ...
            <details><summary>What happens when the Mac sleeps?</summary><p>The fold ends when macOS puts the display to sleep near the end of the close. Turn on Focus on Wake and the desktop comes back into focus when you open the lid.</p></details>
