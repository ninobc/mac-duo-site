      ...
      <main id="top">
            ...
            <div className="install-card">
              <div className="install-copy">
                ...
                <ol>
                  ...
                  <li><strong>Open it.</strong> Mac Duo is signed and notarized by Apple, so it opens like any other app.</li>
        ...
        <section className="section" id="faq">
          <div className="wrap narrow">
            ...
            <details><summary>Why did macOS say &quot;Mac Duo&quot; Not Opened?</summary><p>Versions before 1.0.2 weren&apos;t notarized, so macOS Sequoia showed that warning on first launch. Since 1.0.2 every build is signed with a Developer ID and notarized by Apple, and the download opens without it. If you still have an older copy, download again from this page. The source is public on <a href="https://github.com/ninobc/mac-duo" rel="noopener">GitHub</a>.</p></details>
