...
export const fragmentShader = /* glsl */`
  ...
  uniform float textureScale, maxRadius, blurStrength, blurFloor, maxDim, maxLevel, dimStart, dimReach, dimHinge, dimStrength, visibleTop, sheenAmount, sheenPos, grain, time, brightness, recede;
