...
export const presets = {
  duo:       { startAngle: 90,  span: 60, blurRadius: 135, blurFloor: 0, dimming: 1,   dimStart: 0, dimReach: 0.5,  dimHingeFloor: 0.2,  depth: 1,   eyeDistance: 6.0, eyeHeight: 0, sheen: 0.25, grain: 0.5 },
  soft:      { startAngle: 90,  span: 50, blurRadius: 70,  blurFloor: 0, dimming: 0.7, dimStart: 0, dimReach: 0.75, dimHingeFloor: 0.1,  depth: 0.8, eyeDistance: 6.0, eyeHeight: 0, sheen: 0.25, grain: 0.5 },
  cinematic: { startAngle: 100, span: 70, blurRadius: 160, blurFloor: 0, dimming: 1,   dimStart: 0, dimReach: 0.45, dimHingeFloor: 0.25, depth: 1.2, eyeDistance: 4.5, eyeHeight: 0, sheen: 0.4,  grain: 0.5 },
};
