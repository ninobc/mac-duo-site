...
export const presets = {
  duo:       { startAngle: 92,  span: 58, blurRadius: 125, blurFloor: 0, dimming: 1,   dimStart: 0, dimReach: 0.55, dimHingeFloor: 0.18, depth: 1,   eyeDistance: 5.5, eyeHeight: 0, sheen: 0, grain: 0 },
  soft:      { startAngle: 90,  span: 50, blurRadius: 70,  blurFloor: 0, dimming: 0.7, dimStart: 0, dimReach: 0.75, dimHingeFloor: 0.1,  depth: 0.8, eyeDistance: 6.0, eyeHeight: 0, sheen: 0, grain: 0 },
  cinematic: { startAngle: 100, span: 70, blurRadius: 160, blurFloor: 0, dimming: 1,   dimStart: 0, dimReach: 0.45, dimHingeFloor: 0.25, depth: 1.2, eyeDistance: 4.5, eyeHeight: 0, sheen: 0, grain: 0 },
};
...
export function frame(effect, W, H, angle, eye) {
  ...
  const recede = 1;
  const blurFloor = effect.blurFloor;
  return {
